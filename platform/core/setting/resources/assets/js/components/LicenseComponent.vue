      ...
      <div class="flexbox-annotated-section-content">
        <div class="wrapper-content pd-all-20">
          ...
          <div v-if="!isLoading && !verified">
            ...
            <div class="form-group">
              <div>
                <div class="float-left">
                  <label class="text-title-field" for="purchase_code"
                    >Purchase code</label
                  >
                </div>
            ...
            <div class="form-group">
              <label class="text-title-field" for="buyer"
                >Your username on Envato</label
              >
              <input
                type="text"
                class="next-input"
              ...
              <div>
                <small
                  >Ex: If your profile page is
                  <a
                    href="https://codecanyon.net/user/john-smith"
                    rel="nofollow"
                    >https://codecanyon.net/user/john-smith</a
                  >, then your username on Envato is
            ...
            <div class="form-group">
              <button
                :class="
                  activating ? 'btn btn-info button-loading' : 'btn btn-info'
                "
                type="button"
          ...
          <div v-if="!isLoading && verified">
            <p class="text-info">
              Licensed to {{ license.licensed_to }}. Activated since
