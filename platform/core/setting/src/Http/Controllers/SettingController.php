...
namespace Canopy\Setting\Http\Controllers;

use Assets;
use Canopy\Base\Supports\Core;
use Canopy\Setting\Http\Requests\EmailTemplateRequest;
use Canopy\Setting\Http\Requests\LicenseSettingRequest;
use Canopy\Setting\Http\Requests\MediaSettingRequest;
use Canopy\Setting\Http\Requests\SendTestEmailRequest;
use Canopy\Setting\Http\Requests\SettingRequest;
...
class SettingController extends BaseController
{
    ...
    public function getVerifyLicense(Core $coreApi, BaseHttpResponse $response)
    {
        ...
        $activatedAt = Carbon::createFromTimestamp(Carbon::now()->subWeek());
        $data = [
            'activated_at' => $activatedAt->format('M d Y'),
            'licensed_to'  => 'Oplly',
        ];
