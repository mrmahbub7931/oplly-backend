...
namespace Canopy\Media\Http\Controllers;

use Canopy\Media\Http\Resources\FileResource;
use Canopy\Media\Http\Resources\FolderResource;
...
use Canopy\Media\Services\UploadsManager;
use Canopy\Media\Supports\Zipper;
use Eloquent;
use Exception;
use File;
