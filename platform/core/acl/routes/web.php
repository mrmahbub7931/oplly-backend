...
use Canopy\ACL\Http\Controllers\Auth\ForgotPasswordController;
use Canopy\ACL\Http\Controllers\Auth\LoginController;
use Canopy\ACL\Http\Controllers\Auth\ResetPasswordController;
use Canopy\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'Canopy\ACL\Http\Controllers', 'middleware' => ['web', 'core']], function () {
