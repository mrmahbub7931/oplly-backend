...
<div class="form-group" id="emailGroup">
    ...
    {!! Form::text('username', old('username', app()->environment('demo') ? 'canopy' : null), ['class' => 'form-control', 'placeholder' => trans('core/acl::auth.login.username')]) !!}
</div>
...
{!! apply_filters(BASE_FILTER_AFTER_LOGIN_OR_REGISTER_FORM, null, \Canopy\ACL\Models\User::class) !!}
