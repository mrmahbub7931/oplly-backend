...
namespace Canopy\ACL\Http\Controllers;
...
use Canopy\ACL\Forms\PasswordForm;
use Canopy\ACL\Forms\ProfileForm;
use Canopy\ACL\Forms\UserForm;
use Canopy\ACL\Tables\UserTable;
use Canopy\ACL\Http\Requests\CreateUserRequest;
use Canopy\ACL\Http\Requests\UpdatePasswordRequest;
use Canopy\ACL\Http\Requests\UpdateProfileRequest;
...
use Canopy\ACL\Services\ChangePasswordService;
use Canopy\ACL\Services\CreateUserService;
...
use Canopy\ACL\Http\Requests\AvatarRequest;
use Exception;
