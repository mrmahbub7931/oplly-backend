...
use Canopy\ACL\Notifications\ResetPasswordNotification;
use Canopy\ACL\Traits\PermissionTrait;
 ...
 * @property int|mixed $super_user
 * @property int|mixed $manage_supers
 */
