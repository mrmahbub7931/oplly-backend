...
namespace Canopy\Base\Http\Controllers;
...
use Canopy\Base\Supports\MembershipAuthorization;
use Canopy\Base\Supports\SystemManagement;
use Canopy\Base\Tables\InfoTable;
