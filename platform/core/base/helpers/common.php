...
use Canopy\Base\Facades\DashboardMenuFacade;
use Canopy\Base\Facades\PageTitleFacade;
use Canopy\Base\Supports\Editor;
...
if (!function_exists('dashboard_menu')) {
    /**
     * @return \Canopy\Base\Supports\DashboardMenu
     */
