...
use Canopy\Support\Services\Cache\Cache;
    ...
    public function clearCacheMenuItems(): self
    {
        try {
            ...
            foreach ($nodes as $node) {
                if (!$node->reference_type || !class_exists($node->reference_type) || !$node->reference_id || !$node->reference || !class_exists($node->reference_type)) {
                    continue;
                }
