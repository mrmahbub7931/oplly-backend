...
use Canopy\Theme\Facades\AdminBarFacade;
use Canopy\Theme\Facades\ThemeOptionFacade;
...
if (!function_exists('theme_option')) {
    /**
     * @return \Canopy\Theme\ThemeOption|string
     */
...
if (!function_exists('admin_bar')) {
    /**
     * @return Canopy\Theme\Supports\AdminBar
     */
    function admin_bar()
    {
