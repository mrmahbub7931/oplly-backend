...
namespace Canopy\Theme;

use Canopy\Theme\Contracts\Theme as ThemeContract;
use Canopy\Theme\Exceptions\UnknownLayoutFileException;
use Canopy\Theme\Exceptions\UnknownPartialFileException;
use Canopy\Theme\Exceptions\UnknownThemeException;
use Closure;
use Exception;
use File;
...
class Theme implements ThemeContract
{
    ...
    public function render($statusCode = 200)
    {
        ...
        $content->withHeaders([
            'Author'            => 'Source Town Creative (contact@source.run)',
            'Author-Team'       => 'https://source.run',
            'CMS'               => 'Canopy CMS',
