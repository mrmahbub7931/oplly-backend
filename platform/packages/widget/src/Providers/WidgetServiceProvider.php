...
namespace Canopy\Widget\Providers;

use Canopy\Base\Supports\Helper;
use Canopy\Base\Traits\LoadAndPublishDataTrait;
use Canopy\Widget\Factories\WidgetFactory;
use Canopy\Widget\Misc\LaravelApplicationWrapper;
use Canopy\Widget\Models\Widget;
use Canopy\Widget\Repositories\Caches\WidgetCacheDecorator;
use Canopy\Widget\Repositories\Eloquent\WidgetRepository;
use Canopy\Widget\Repositories\Interfaces\WidgetInterface;
use Canopy\Widget\WidgetGroupCollection;
use Canopy\Widget\Widgets\Text;
use Event;
use File;
...
class WidgetServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('canopy.widget', function () {
            return new WidgetFactory(new LaravelApplicationWrapper);
        });

        $this->app->singleton('canopy.widget-group-collection', function () {
