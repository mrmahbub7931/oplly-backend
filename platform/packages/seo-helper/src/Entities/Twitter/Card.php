...
namespace Canopy\SeoHelper\Entities\Twitter;

use Canopy\SeoHelper\Contracts\Entities\MetaCollectionContract;
use Canopy\SeoHelper\Contracts\Entities\TwitterCardContract;
use Canopy\SeoHelper\Exceptions\InvalidTwitterCardException;
