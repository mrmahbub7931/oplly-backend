...
namespace Canopy\DevTool\Commands;

use Canopy\DevTool\Commands\Abstracts\BaseMakeCommand;
use File;
...
class PackageCreateCommand extends BaseMakeCommand
{
    ...
    public function handle()
    {
        ...
        $this->line('<info>Add</info> <comment>"canopy/' . $package . '": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to install this package!');
        $this->line('------------------');
