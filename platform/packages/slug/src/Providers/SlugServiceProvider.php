...
use Canopy\Slug\Models\Slug;
use Canopy\Slug\Repositories\Caches\SlugCacheDecorator;
use Canopy\Slug\Repositories\Eloquent\SlugRepository;
use Canopy\Slug\Repositories\Interfaces\SlugInterface;
use Canopy\Slug\SlugHelper;
use Event;
