...
namespace Canopy\Translation\Http\Controllers;

use App;
use Assets;
use Canopy\Base\Http\Controllers\BaseController;
use Canopy\Base\Http\Responses\BaseHttpResponse;
use Canopy\Base\Supports\Language;
use Canopy\Translation\Http\Requests\LocaleRequest;
use Canopy\Translation\Http\Requests\TranslationRequest;
use Canopy\Translation\Manager;
use DB;
use File;
use Illuminate\Http\Request;
use Canopy\Translation\Models\Translation;
