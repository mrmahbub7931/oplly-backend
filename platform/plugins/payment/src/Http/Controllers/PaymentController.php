...
namespace Canopy\Payment\Http\Controllers;
...
use Canopy\Payment\Http\Requests\CheckoutRequest;
use Canopy\Payment\Http\Requests\PaymentMethodRequest;
use Canopy\Payment\Http\Requests\PayPalPaymentCallbackRequest;
use Canopy\Payment\Http\Requests\UpdatePaymentRequest;
...
use Canopy\Payment\Tables\PaymentTable;
...
use Stripe\Exception\OAuth\InvalidRequestExceptionException;
use Throwable;
        ...
        switch ($payment->payment_channel) {
            ...
            case PaymentMethodEnum::STRIPE:
                try {
                    ...
                    $detail = view('plugins/payment::stripe.detail', ['issue' => $e->getMessage()])->render();
                }
