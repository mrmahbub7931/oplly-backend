...
namespace Canopy\SimpleSlider\Http\Controllers;
...
use Canopy\SimpleSlider\Forms\SimpleSliderItemForm;
use Canopy\SimpleSlider\Http\Requests\SimpleSliderItemRequest;
