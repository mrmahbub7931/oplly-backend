...
namespace Canopy\Analytics\Providers;

use Canopy\Analytics\Analytics;
use Canopy\Analytics\AnalyticsClient;
use Canopy\Analytics\AnalyticsClientFactory;
use Canopy\Analytics\Facades\AnalyticsFacade;
use Canopy\Base\Traits\LoadAndPublishDataTrait;
use Illuminate\Foundation\AliasLoader;
use Illuminate\Support\ServiceProvider;
use Canopy\Analytics\Exceptions\InvalidConfiguration;
