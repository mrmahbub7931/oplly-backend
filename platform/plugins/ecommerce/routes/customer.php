...
Route::group(['namespace' => 'Canopy\Ecommerce\Http\Controllers\Customers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix(), 'middleware' => 'auth'], function () {
        Route::group(['prefix' => 'customers', 'as' => 'customer.'], function () {
            Route::resource('', 'CustomerController')->parameters(['' => 'customer']);

            Route::get('get-customer-order-reports/{id}', [
                'as'         => 'get-customer-order-reports',
                'uses'       => 'CustomerController@getCustomerOrderReports',
...
Route::group([
    ...
    Route::get('download-video/{id}', [
        'as'         => 'download-video',
        'uses'       => 'PublicController@getDownloadVideo',
        'permission' => 'orders.edit',
    ]);

    Route::get('orders/modify/{id}', [
        'as'   => 'orders.modify',
        'uses' => 'PublicController@getModifyOrder',
    ]);

    Route::post('orders/modify/{id}', [
        'as'   => 'orders.modify.post',
        'uses' => 'PublicController@postModifyOrder',
    ]);
