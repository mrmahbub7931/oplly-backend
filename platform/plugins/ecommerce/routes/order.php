    ...
    Route::group(['prefix' => BaseHelper::getAdminPrefix(), 'middleware' => 'auth'], function () {
        Route::group(['prefix' => 'orders', 'as' => 'orders.'], function () {
            ...
            Route::get('download-video/{id}', [
                'as'         => 'download-video',
                'uses'       => 'OrderController@getDownloadVideo',
                'permission' => 'orders.edit',
            ]);

            Route::post('upload-video/{id}',[
                'as'        =>  'upload-order-video',
                'uses'      =>  'OrderController@uploadOrderVideo',
                'permission' => 'orders.edit',
            ]);
            ...
            Route::post('coupon/apply', [ // coupon goes here
...
Route::group(['namespace' => 'Canopy\Ecommerce\Http\Controllers\Fronts', 'middleware' => ['web', 'core']], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        Route::group(['prefix' => 'checkout/{token}', 'as' => 'public.checkout.'], function () {
            ...
            Route::get('failed', [
                'as'   => 'failed',
                'uses' => 'PublicCheckoutController@getCheckoutFailed',
            ]);
