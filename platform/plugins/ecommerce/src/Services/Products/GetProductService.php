...
class GetProductService
{
    ...
    public function getProduct(Request $request, $category = null, $brand = null, array $with = [])
    {
        $queryVar = [
            ...
            'allow_speed_service'   => $request->input('allow_speed_service'),
            ...
            'num'         => $request->input('num') ? (int)$request->input('num') : (int)theme_option(
        ...
        $products = $this->productRepository->filterProducts(
            [
                ...
                'allow_speed_service'    => $queryVar['allow_speed_service'],
                'rating5'                => $queryVar['rating5'],
                'rating4'                => $queryVar['rating4'],
                'rating3'                => $queryVar['rating3'],
                'rating2'                => $queryVar['rating2'],
                'rating1'                => $queryVar['rating1'],
     ...
     * @return mixed
     */
    public function getProductsInCategory(Request $request, string $category)
    {
        return $this->productRepository->getProductsByCategories([
            'categories' => [
                'by'       => 'name',
                'value_in' => [$category],
            ]
