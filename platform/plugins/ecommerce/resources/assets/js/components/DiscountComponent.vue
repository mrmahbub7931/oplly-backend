      ...
      <div class="wrapper-content">
        <div class="pd-all-20 ws-nm">
          <label class="title-product-main text-no-bold"
            ><span v-if="!is_promotion">{{ __("Create coupon code") }}</span
            ><span v-if="is_promotion">{{
              __("Create discount promotion")
            }}</span></label
          >
          <a
            href="#"
            class="btn-change-link float-right"
            v-on:click="generateCouponCode($event)"
            v-show="!is_promotion"
            >{{ __("Generate coupon code") }}</a
          >
          <div class="form-group mt15 mb0">
            ...
            <p class="type-subdued mt5 mb0" v-show="!is_promotion">
              {{
                __("Customers will enter this coupon code when they checkout")
              }}.
            </p>
          </div>
        </div>
        <div class="pd-all-20 border-top-color">
          ...
          <div
            class="form-group mb0 mt15"
            v-show="!is_promotion && !is_unlimited"
          >
        ...
        <div class="pd-all-20 border-top-color">
          ...
          <div class="form-inline form-group discount-input mt15 mb0 ws-nm">
            <div
              class="ui-select-wrapper inline_block mb5"
            ...
            <span
              class="lb-dis"
              v-show="type_option !== 'shipping' && type_option"
            >
              {{ __("apply for") }}</span
            >
            <div v-show="type_option !== 'shipping' && type_option">
                ...
                <div class="ui-select-wrapper" style="min-width: 200px">
                  ...
                  >
                    <option
                      ...
                      v-bind:value="product_collection.id"
                    >
              ...
              <div
                ...
                v-if="
                  target === 'specific-product' && type_option !== 'shipping'
                "
                style="margin-right: 10px"
              >
                <div
                  class="drop-select-search drop-control dropdown dropdown-collection"
                >
                  ...
                  >
                    <span class="overflow-title max-250 p-r15">{{
                      product_text
                    }}</span>
                  </button>
              ...
              <div
                ...
                v-if="
                  target === 'product-variant' && type_option !== 'shipping'
                "
                style="margin-right: 10px"
              >
                <div
                ...
                >
                  ...
                  >
                    <div class="panel-body">
                      <div class="list-search-data">
                        ...
                        <ul class="clearfix" v-show="!loading">
                          <li
                            v-for="product_variant in product_variants.data"
                    ...
                    <div
                      class="panel-footer"
                      v-if="
                        product_variants.next_page_url ||
                        product_variants.prev_page_url
                      "
                    >
                      <div class="btn-group float-right">
                        <button
                          ...
                          @click="
                            loadListProductsForSearch(
                              1,
                              product_variants.prev_page_url
                                ? product_variants.current_page - 1
                                : product_variants.current_page,
                              true
                            )
                          "
                          v-bind:class="{
                        ...
                        <button
                          ...
                          "
                          v-bind:class="{
                            'btn btn-secondary': product_variants.next_page_url,
                            'btn btn-secondary disable': !product_variants.next_page_url,
                          }"
              ...
              >
                <div class="ui-select-wrapper">
                  <select
                    ...
                    v-model="discount_on"
                  >
                    <option value="per-order">
                      {{ __("One time per order") }}
                    </option>
                    <option value="per-every-item">
                      {{ __("One time per product in cart") }}
                    </option>
                  </select>
                  <svg class="svg-next-icon svg-next-icon-size-16">
                    <use
          ...
          <div
            class="clearfix"
            v-if="variants.length && target === 'product-variant'"
          >
            <div class="mt20">
              <label class="text-title-field"
                >{{ __("Selected products") }}:</label
              >
            </div>
                  ...
                  <tr v-for="variant in variants">
                    ...
                    <td class="pl5 p-r5 min-width-200-px">
                      <a
                        ...
                        v-bind:href="variant.product_link"
                        target="_blank"
  ...
  methods: {
    ...
    getListProductCollections: function () {
      ...
      if (_.isEmpty(context.product_collections)) {
        ...
        axios
          .get(
            route("product-collections.get-list-product-collections-for-select")
          )
          .then((res) => {
