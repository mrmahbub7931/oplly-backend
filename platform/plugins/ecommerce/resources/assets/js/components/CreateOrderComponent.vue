<template>
  <div class="flexbox-grid no-pd-none">
              ...
              <table class="table-normal">
                <tbody>
                  <tr v-for="variant in child_products">
                    ...
                    <td class="pl5 p-r5 min-width-200-px">
                      ...
                      >
                        <span
                          v-for="(
                            productItem, index
                          ) in variant.variation_items"
                        >
                          {{ productItem.attribute_title }}
                          <span
                            v-if="index !== variant.variation_items.length - 1"
                            >/</span
                          >
                        </span>
                      </p>
                    ...
                    <td
                      class="pl5 p-r5 width-100-px min-width-100-px text-center"
                    >
                      <div class="dropup dropdown-priceOrderNew">
                        <div class="inline_block dropdown">
                          <a class="wordwrap hide-print"
                            >{{ variant.price }} {{ currency }}</a
                          >
                        </div>
                      </div>
                    </td>
                    <td
                      class="pl5 p-r5 width-20-px min-width-20-px text-center"
                    >
                      x
                    </td>
                    <td class="pl5 p-r5 width-100-px min-width-100-px">
                      <input
                        class="next-input p-none-r"
            ...
            <div class="box-search-advance product">
              ...
              >
                <div class="panel-body">
                  ...
                  >
                    <img
                      ...
                      alt="icon"
                    />
                    <span class="ml10" data-bind="text:CustomFieldName">{{
                      ...
                      <li
                        ...
                        v-on="
                          !product_item.variations.length
                            ? {
                                click: () => selectProductVariant(product_item),
                              }
                            : {}
                        "
                      >
                        <div
                          class="wrap-img inline_block vertical-align-t float-left"
                        >
                          <img
                            class="thumb-image"
                        ...
                        <label
                          ...
                          <span v-if="!product_item.variations.length">
                            <span
                              v-if="product_item.is_out_of_stock"
                              class="text-danger"
                              ><small
                                >&nbsp;({{ __("Out of stock") }})</small
                              ></span
                            >
                            <span
                              v-if="
                        ...
                        <div v-if="product_item.variations.length">
                          ...
                          <ul>
                            <li
                              ...
                              @click="
                                selectProductVariant(product_item, variation)
                              "
                            ...
                            >
                              ...
                              <span
                                v-if="variation.is_out_of_stock"
                                class="text-danger"
                                ><small
                                  >&nbsp;({{ __("Out of stock") }})</small
                                ></span
                ...
                <div
                  class="panel-footer"
                  v-if="
                    list_products.next_page_url || list_products.prev_page_url
                  "
                >
                  <div class="btn-group float-right">
                    <button
                      ...
                      @click="
                        loadListProductsAndVariations(
                          list_products.prev_page_url
                            ? list_products.current_page - 1
                            : list_products.current_page,
                          true
                        )
                      "
                      v-bind:class="{
                        'btn btn-secondary': list_products.current_page !== 1,
                    ...
                    <button
                      ...
                      "
                      v-bind:class="{
                        'btn btn-secondary': list_products.next_page_url,
                        'btn btn-secondary disable': !list_products.next_page_url,
                      }"
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="text-title-field" for="txt-note">{{
                  __("Note")
                }}</label>
                <textarea
                ...
                >
                  <tbody>
                    <tr>
                      ...
                      <td class="pl10">
                        {{ child_sub_amount | formatPrice }} {{ currency }}
                      </td>
                    </tr>
                    <tr>
                      <td>
                        ...
                        <p
                          class="mb0 font-size-12px"
                          v-if="discount_description && has_applied_discount"
                        >
                    ...
                    <tr>
                      <td>
                        ...
                        <p
                          class="mb0 font-size-12px"
                          v-if="child_shipping_method_name"
                        >
                    ...
                    <tr class="text-no-bold">
                      ...
                      <td class="pl10">
                        {{ child_total_amount | formatPrice }} {{ currency }}
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="row">
              ...
              <div class="flexbox-grid-default mt5 mb5">
                ...
                <div class="flexbox-auto-content">
                  <div class="text-upper ws-nm">
                    {{ __("Confirm payment and create order") }}
                  </div>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-12 col-lg-6 text-right">
              <button
                ...
                v-b-modal.make-paid
                :disabled="!child_product_ids.length"
              >
                {{ __("Paid") }}
              </button>
              <button
                ...
                :disabled="
                  !child_product_ids.length || child_total_amount === 0
                "
              >
                {{ __("Pay later") }}
              </button>
        ...
        <div v-if="!child_customer_id || !child_customer">
          <div class="next-card-section">
            <div class="flexbox-grid-default mb15">
              <div class="flexbox-auto-content">
                <label class="title-product-main">{{
            ...
            <div class="findcustomer">
              <div class="box-search-advance customer">
                ...
                <div
                  ...
                  v-bind:class="{
                    active: customers,
                    hidden: hidden_customer_search_panel,
                  }"
                >
                  <div class="panel-body">
        ...
        <div v-if="child_customer_id && child_customer">
          ...
          <div class="next-card-section border-none-t">
            <ul class="ws-nm">
              ...
              <li class="mt10">
                <a class="hover-underline text-capitalize" href="#">{{
                  child_customer.name
                }}</a>
              </li>
              <li>
                <div class="flexbox-grid-default">
                  <div class="flexbox-auto-content-left overflow-ellipsis">
                    <a :href="'mailto:' + child_customer.email">
                      <span>{{
                        child_customer.email ? child_customer.email : "-"
                      }}</span>
                    </a>
                  </div>
                  <div class="flexbox-auto-left">
              ...
              <li class="text-infor-subdued mt15">
                <div v-if="child_customer_addresses.length > 1">
                  <div class="ui-select-wrapper">
                    <select
                      class="ui-select"
                      @change="selectCustomerAddress($event)"
                    >
                      <option
                        ...
                        :selected="
                          ...
                          parseInt(customer_address.email)
                        "
                      >
                        {{
        ...
        <div class="col-8">
          ...
          <div class="form-group">
            <label class="next-label">
              ...
              />
              {{
                __("Allow customer checkout when this product out of stock?")
              }}</label
            >
          </div>
        </div>
            ...
            <div class="flexbox-grid-default">
              <div class="flexbox-auto-left">
                <div class="flexbox-input-group">
                  <button
                    value="amount"
                    class="item-group btn btn-secondary btn-active"
        ...
        <div class="next-form-grid">
          <div class="next-form-grid-cell">
            ...
            <div
              ...
              v-bind:class="{ 'field-has-error': has_invalid_coupon }"
            >
              <input
                class="next-input next-input--invisible"
                v-model="coupon_code"
          ...
          <div class="ui-banner ui-banner--status-info">
            ...
            <div class="ui-banner__content">
              <h2 class="ui-banner__title">
                {{ __("How to select configured shipping?") }}
              </h2>
              <div class="ws-nm">
                {{
                  __(
            ...
            <div class="ui-select-wrapper">
              <select class="ui-select">
                <option
                  ...
                  :data-name="shipping_method.name"
                  v-for="(
    ...
    >
      <label class="ws-nm">{{
        __("Confirm payment is paid for this order")
      }}</label>
      <p>
        {{
          __(
      ...
      <p>
        {{ __("Paid amount") }} :
        <span>{{ child_total_amount | formatPrice }} {{ currency }}</span>
      </p>
    </b-modal>
    ...
    >
      <label class="ws-nm">{{
        __("Confirm that payment for this order will be paid later")
      }}</label>
      <p>
        {{
          __(
...
export default {
  ...
  methods: {
    loadListCustomersForSearch: function (page = 1, force = false) {
      ...
      if (_.isEmpty(context.customers.data) || force) {
        ...
        axios
          ...
          .catch((res) => {
            Canopy.handleError(res.response.data);
          });
      }
    },
    ...
    selectProductVariant: function (product, variation = null) {
      if (
        (!_.isEmpty(variation) && variation.is_out_of_stock) ||
        (_.isEmpty(variation) && product.is_out_of_stock)
      ) {
        Canopy.showError("Cannot select out of stock product!");
        return false;
      }
      ...
      if (!_.isEmpty(variation)) {
        if (!_.includes(this.child_product_ids, variation.product_id)) {
          ...
          productItem.product_link = route(
            "products.edit",
        ...
        if (!_.includes(this.child_product_ids, product.id)) {
    ...
    createOrder: function ($event, paid = false) {
      ...
      axios
        ...
        .then((res) => {
          ...
          if (data.error) {
            Canopy.showError(Canopy.showError(res.data.message));
          } else {
            Canopy.showSuccess(res.data.message);
            if (paid) {
    ...
    createProduct: function ($event) {
      ...
      axios
        .post(
          route("products.create-product-when-creating-order"),
          context.product
        )
        .then((res) => {
          if (res.data.error) {
    ...
    updateOrderAddress: function ($event) {
      ...
      if (this.customer) {
        ...
        this.child_customer_address.name = $modal
          .find(".customer-address-name")
          .val();
        this.child_customer_address.email = $modal
          .find(".customer-address-email")
          .val();
        this.child_customer_address.phone = $modal
          .find(".customer-address-phone")
          .val();
        this.child_customer_address.address = $modal
          .find(".customer-address-address")
          .val();
        this.child_customer_address.city = $modal
          .find(".customer-address-city")
          .val();
        this.child_customer_address.state = $modal
          .find(".customer-address-state")
          .val();
        this.child_customer_address.country = $modal
    ...
    loadCustomerAddress: function () {
      ...
      axios
        .get(
          route("customers.get-customer-addresses", context.child_customer_id)
        )
        .then((res) => {
          context.child_customer_addresses = res.data.data;
          if (!_.isEmpty(context.child_customer_addresses)) {
            context.child_customer_address = _.first(
              context.child_customer_addresses
            );
          }
        })
        .catch((res) => {
    ...
    selectShippingMethod: function ($event) {
      ...
      if (context.shipping_type === "free-shipping") {
        ...
        if (!_.isEmpty(selected_shipping)) {
          ...
          context.child_shipping_amount = parseFloat(
            selected_shipping[2].trim()
          );
          context.child_shipping_method_name = $($event.target)
            .find(".ui-select option:selected")
            .data("name");
        }
      }
    ...
    loadAvailableShippingMethods: function () {
      ...
      axios
        .get(
          route("orders.get-available-shipping-methods", {
            address: context.child_customer_address.address,
            country: context.child_customer_address.country,
            state: context.child_customer_address.state,
            city: context.child_customer_address.city,
    ...
    handleAddDiscount: function (event) {
      ...
      if (!_.isEmpty(context.coupon_code)) {
        axios
          ...
          .then((res) => {
            if (res.data.error) {
              Canopy.showError(res.data.message);
        ...
        if (this.discount_type === "percentage") {
          context.child_discount_amount =
            (context.child_total_amount * context.discount_custom_value) / 100;
        } else {
    ...
    calculateAmount: function (products) {
      ...
      _.each(products, function (item) {
        context.child_sub_amount +=
          parseFloat(item.price) * parseInt(item.select_qty);
      });
      context.child_total_amount =
        parseFloat(context.child_sub_amount) -
        parseFloat(context.child_discount_amount) +
        parseFloat(context.child_shipping_amount);
