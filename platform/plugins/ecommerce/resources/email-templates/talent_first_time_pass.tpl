...
<a href="{{ reset_link }}">Set your password</a> <br /><br />

Regards, <br />

<hr />

If you’re having trouble clicking the "Set your password" button, copy and paste the URL below into your web browser: {{ reset_link }}
