        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-md-10">
                <div class="login_wrap">
                    @if (auth('customer')->check() and auth('customer')->user()->talent)
                        <div class="padding_eight_all text-center">
                            ...
                            <form method="POST" action="{{ route('talent.signup.post') }}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="form-group nice--input col-12 col-md-6">
                                        <label for="txt-channel">{{ __('Their Social Channel') }}</label>
                              ...
                              Policy</a></span></label>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-block">{{ __('Send Invite') }}</button>
                                </div>
                            </form>
                        ...
                        <div class="padding_eight_all text-center">
                            ...
                            <form method="POST" action="{{ route('talent.signup.post') }}">
                                ...
                                <div class="form-group nice--input">
                                    ...
                                    <input class="form-control" name="first_name" id="txt-fname" type="text"
                                           value="{{ old('first_name') }}" placeholder="">
                                  @if ($errors->has('first_name'))
                                        <span class="text-danger">{{ $errors->first('first_name') }}</span>
                                    @endif
                                ...
                                <div class="row">
                                    <div class="form-group nice--input col-12 col-md-6">
                                        ...
                                        <select class="form-control" name="channel" id="txt-channel" value="{{ old('channel') }}"
                                                placeholder="">
                                            <option value=""></option>
                                            <option value="facebook">Facebook</option>
                                            <option value="instagram">Instagram</option>
                                    ...
                                    <div class="form-group nice--input col-12 col-md-6">
                                        <label for="txt-followers">{{ __('No of followers') }}</label>
                                        <input class="form-control" name="followers" id="txt-followers" type="text"
                                               value="{{ old('followers') }}" placeholder="">
                                        @if ($errors->has('followers'))
                                            <span class="text-danger">{{ $errors->first('followers') }}</span>
                                        @endif
                                ...
                                <div class="form-group nice--input">
                                    <label for="txt-handle">{{ __('Social Media Username') }}</label>
                                    <input class="form-control" name="handle" id="txt-handle" type="text"
                                           value="{{ old('handle') }}" placeholder="">
                                    @if ($errors->has('handle'))
                                        <span class="text-danger">{{ $errors->first('handle') }}</span>
                                    @endif
