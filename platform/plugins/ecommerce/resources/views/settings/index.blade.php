...
<div class="max-width-1200">
                ...
                <div class="form-group mb0">
                    ...
                    <div class="ui-select-wrapper">
                        <select name="store_country" class="ui-select" id="store_country">
                            @foreach(['' => trans('plugins/ecommerce::ecommerce.setting.select_country')] + \Canopy\Base\Supports\Helper::countries() as $countryCode => $countryName)
    ...
    <div class="flexbox-annotated-section">
        ...
        <div class="flexbox-annotated-section-content">
            <div class="wrapper-content pd-all-20">
                <div class="form-group">
                    <label class="text-title-field" for="shopping_cart_enabled">{{ trans('plugins/ecommerce::ecommerce.setting.enable_cart') }}
                    </label>
                    <label class="hrv-label">
                        <input type="radio" name="shopping_cart_enabled" class="hrv-radio" value="1" @if (EcommerceHelper::isCartEnabled()) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                    </label>
                    <label class="hrv-label">
                        <input type="radio" name="shopping_cart_enabled" class="hrv-radio" value="0" @if (!EcommerceHelper::isCartEnabled()) checked @endif>{{ trans('core/setting::setting.general.no') }}
                    </label>
                </div>

                <div class="form-group">
                    <label class="text-title-field" for="ecommerce_tax_enabled">{{ trans('plugins/ecommerce::ecommerce.setting.enable_tax') }}
                    </label>
                    <label class="hrv-label">
                        <input type="radio" name="ecommerce_tax_enabled" class="hrv-radio" value="1" @if (EcommerceHelper::isTaxEnabled()) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                    </label>
                    <label class="hrv-label">
                        <input type="radio" name="ecommerce_tax_enabled" class="hrv-radio" value="0" @if (!EcommerceHelper::isTaxEnabled()) checked @endif>{{ trans('core/setting::setting.general.no') }}
                    </label>
                </div>

                <div class="form-group">
                    <label class="text-title-field" for="review_enabled">{{ trans('plugins/ecommerce::ecommerce.setting.enable_review') }}
                    </label>
                    <label class="hrv-label">
                        <input type="radio" name="review_enabled" class="hrv-radio" value="1" @if (EcommerceHelper::isReviewEnabled()) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                    </label>
                    <label class="hrv-label">
                        <input type="radio" name="review_enabled" class="hrv-radio" value="0" @if (!EcommerceHelper::isReviewEnabled()) checked @endif>{{ trans('core/setting::setting.general.no') }}
                    </label>
                </div>

                <div class="form-group">
                    <label class="text-title-field" for="enable_quick_buy_button">{{ trans('plugins/ecommerce::ecommerce.setting.enable_quick_buy_button') }}
                    </label>
                    <label class="hrv-label">
                        <input type="radio" name="enable_quick_buy_button" class="hrv-radio" value="1" @if (EcommerceHelper::isQuickBuyButtonEnabled()) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                    </label>
                    <label class="hrv-label">
                        <input type="radio" name="enable_quick_buy_button" class="hrv-radio" value="0" @if (!EcommerceHelper::isQuickBuyButtonEnabled()) checked @endif>{{ trans('core/setting::setting.general.no') }}
                    </label>
                </div>

                <div class="form-group">
                    <label class="text-title-field" for="quick_buy_target_page">{{ trans('plugins/ecommerce::ecommerce.setting.quick_buy_target') }}
                    </label>
                    <div class="ui-select-wrapper">
    ...
    <div class="flexbox-annotated-section">
        <div class="flexbox-annotated-section-annotation">
            ...
            <div class="annotated-section-description pd-all-20 p-none-t">
                <p class="color-note">Please provide labels and colours for badges used for talents</p>
            </div>
        </div>
        <div class="flexbox-annotated-section-content">
            <div class="wrapper-content pd-all-20">
                <div class="form-group row">
                    <div class="col-sm-6 p-none-l">
                        <label class="text-title-field" for="fast_service_label">Fast Service Label</label>
                        <input type="text" class="next-input" name="fast_service_label" id="fast_service_label" value="{{ get_ecommerce_setting('fast_service_label') }}">
   
                    </div>
                    <div class="col-sm-6 rps-p-l-none">
                        <label class="text-title-field" for="fast_service_label_color">Fast Service Colour</label>
                        <input type="color" class="next-input" style="height:36px" name="fast_service_label_color" id="fast_service_label_color" value="{{ get_ecommerce_setting('fast_service_label_color') }}">
                    </div>
                </div>
