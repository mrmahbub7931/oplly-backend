<div class="customer_report_table_wrap">
    <div class="row">
        <div class="col">
            <table class="table table-bordered talent-reports-datatable">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Customer Name</th>
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('.talent-reports-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('talent.get-talent-order-reports-table', $talent_id) }}",
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            {data: 'user.name', name: 'Customer_Name'},
