<div class="row price-group">
  <input type="hidden" value="{{ old('sale_type', $product ? $product->sale_type : 0) }}"
  ...
  <div class="col-md-4">
    <div class="form-group @if ($errors->has('sku')) has-error @endif">
      ...
      {!! Form::text('sku', old('sku', $product ? $product->sku : null), ['class' =>
      'next-input', 'id' => 'sku', 'data-counter' => 30]) !!}
    </div>
  </div>
  ...
  <div class="col-md-4">
    <div class="form-group">
      <label
        class="text-title-field">{{ trans('plugins/ecommerce::products.form.price') }}</label>
  ...
  <div
    ...
    <div class="form-group">
      <label
        class="text-title-field">{{ trans('plugins/ecommerce::products.form.date.start') }}</label>
  ...
  <div
    ...
    <div class="form-group">
      <label
        class="text-title-field">{{ trans('plugins/ecommerce::products.form.date.end') }}</label>
...
<div
  class="storehouse-info @if (old('with_storehouse_management', $product ? $product->with_storehouse_management : ($originalProduct->with_storehouse_management ?? 0)) == 0) hidden @endif">
  <div class="form-group">
    <label
  ...
  <div class="form-group">
    <label class="text-title-field">
      ...
      <input type="checkbox" name="allow_checkout_when_out_of_stock" class="hrv-checkbox"
        value="1" @if (old('allow_checkout_when_out_of_stock', $product ?
        $product->allow_checkout_when_out_of_stock :
      ($originalProduct->allow_checkout_when_out_of_stock ?? 0)) == 1) checked @endif>
