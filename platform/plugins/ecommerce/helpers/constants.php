...
if (!defined('ECOMMERCE_GROUP_CACHE_KEY')) {
    define('ECOMMERCE_GROUP_CACHE_KEY', 'Canopy\Ecommerce\Repositories');
}
...
if (!defined('OCCASION_MODULE_SCREEN_NAME')) {
    define('OCCASION_MODULE_SCREEN_NAME', 'occasion');
}
...
if (!defined('TALENT_MODULE_SCREEN_NAME')) {
    define('TALENT_MODULE_SCREEN_NAME', 'talent');
}
