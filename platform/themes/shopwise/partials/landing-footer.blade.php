...
window.siteUrl = "{{ url('') }}";
    ...
    (theme_option('facebook_chat_enabled', 'yes') == 'yes' &&
    theme_option('facebook_page_id')))
    <div id="fb-root"></div>
    <script>
...
(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    @if (theme_option('facebook_chat_enabled', 'yes') == 'yes' &&
    theme_option('facebook_page_id'))
    <div class="fb-customerchat" attribution="install_email"
