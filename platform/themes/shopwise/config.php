    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme) {
            ...
            $theme->asset()->container('footer')->usePath()->add('scripts', 'js/scripts.js', ['jquery'], [], '1.0.15');
            $theme->asset()->container('footer')->usePath()->add('backend-js', 'js/backend.js', ['jquery'], [], '1.0.15');
            ...
            if (function_exists('shortcode')) {
                $theme->composer(['*'], function (\Canopy\Shortcode\View\View $view) {
                    \Theme::asset()->container('footer')->usePath()->add('app-js', 'js/app.js', ['jquery', 'carousel-js'], [], '1.0.15');
                    $view->withShortcodes();
                });
            }
        },
