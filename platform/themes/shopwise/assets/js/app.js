...
import ProductReviewsSliderComponent from './components/ReviewsSliderComponent';
import FlashSaleProductsComponent from './components/FlashSaleProductsComponent';
import SlidingBannersComponent from './components/SlidingBannersComponent';
import BookLiveComponent from './components/BookLiveComponent';
import SearchBarComponent from './components/SearchBarComponent';
import Vue from 'vue';
import Autocomplete from './components/v-autocomplete/Autocomplete';
...
Vue.component('book-live', BookLiveComponent);
...
Vue.component('products-by-category-component', ProductsByCategoryComponent);
...
Vue.component('product-reviews-slider-component', ProductReviewsSliderComponent);
Vue.component('flash-sale-products-component', FlashSaleProductsComponent);
Vue.component('sliding-banners-component', SlidingBannersComponent);
Vue.component('search-bar-component', SearchBarComponent);
...
if ($('#vue-related-products').length) {
    new Vue({
