...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="form-group nice--input @if ($errors->has('dob')) has-error @endif">
        <label for="date_of_birth">{{ __('Date of birth') }}:</label>
        <input id="date_of_birth" type="text" class="form-control" name="dob"
      ...
      <div class="form-group nice--input @if ($errors->has('phone')) has-error @endif">
