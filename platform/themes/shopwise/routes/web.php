...
Route::group(['namespace' => 'Theme\Shopwise\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::post('ajax/notify-when-back', 'ShopwiseController@postNotifyWhenBack')
            ->name('public.talent.notify-when-back');
        ...
        Route::get('ajax/get-product-by-category/{id}', 'ShopwiseController@ajaxGetProductsByCategory')
            ->name('public.ajax.products-by-category');
